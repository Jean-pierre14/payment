<?php $get_std = false; include("./includes/nav.php"); include("./db.con.php"); ?>
<?php
            ...
            <div class="col-md-4 col-sm-12 sidebar">
                    ...
                    <div class="header bg-success p-2">
                        <form action="py.php" method="post" id="search" autocomplete="on">
                            <input type="text" id="search_txt" name="txt" id="txt" placeholder="Search..." class="form-control">
                        </form>
                    </div>
                        ...
                        <ul id="normal-list">
                            <?php
                                ...
                                while($row = mysqli_fetch_array($run)){
                                    ...
                                    ?>
                                    <?php if($get_std == true):?>
                                        <li title="Student <?php print $stud_name.' '.$stud_sname.' ni  '.$row['class'];?>"><a href="py.php?student=<?php print $stud_id;?>"><?php print $stud_name.' '. $stud_sname;?></a></li>
                                    <?php else: ?>
                                        <li title="Student <?php print $stud_name.' '.$stud_sname.' ni  '.$row['class'];?>"><a href="py.php?student=<?php print $stud_id;?>"><?php print $stud_name.' '. $stud_sname;?></a></li>
                                    <?php endif;?>
                                    <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <?php
                            if(isset($_POST['py'])){
                                ...
                                if(empty($mount_pay)){array_push($error, "The mount field is empty");}
                                if(empty($bank)){array_push($error, "The Bank field is empty");}
                        ...
                        <div class="ui form-group">
                            ...
                            <input type="number" name="mount" value="<?php print $mount;?>" id="mount" placeholder="Mount payed" class="form-control">
                        </div>
                        ...
                        <div class="form-group mt-1">
                            <button type="submit" id="pay" name="py_stud" class="ui labeled button icon submit red"><i class="icon refresh"></i>Pay now!!</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 m-0 mt-1">
                        <div class="header white bg-success p-2">
                            <h3 class="text-center ui" title="ULK the best private university in Rwanda" style="cursor: pointer">ULK UNIVERSITE LIBRE DE KIGALI</h3>
                            <p class="text-center" title="ULK the best private university in Rwanda" style="cursor: pointer">&copy; <?php print date("Y");?> copyright</p>
                        </div>
                    </div>
                </div>
                    <?php
                    ...
                    <div class="container-fluid m-0 p-0">
                        <div class="row">
                            <div class="col-md-6 col-xl-3 mt-1 text-center">
                                ...
                                <a href="./images/ulk.jpg" data-lightbox="mygallery"><img src="./images/ulk.png" alt="" class="img-fluid"></a>
                                <p>University in Rwanda</p>
                            </div>

                            <div class="col-md-6 col-xl-3 mt-1 text-center">
                                <h3 class="text-center">Registration</h3>
                                <a href="./images/registration.jpg" data-lightbox="mygallery"><img src="./images/registration.png" alt="" class="img-fluid"></a>
                                <p>Fast and serieuse</p>
                            </div>

                            <div class="col-md-6 col-xl-3 mt-1 text-center">
                                <h3 class="text-center">Christans</h3>
                                <a href="./images/christian.jpg" data-lightbox="mygallery"><img src="./images/christian.png" alt="" class="img-fluid"></a>
                                <p>Put God first</p>
                            </div>

                            <div class="col-md-6 col-xl-3 mt-1 text-center">
                                <h3 class="text-center">Police</h3>
                                <a href="./images/police.png" data-lightbox="mygallery"><img src="./images/police.png" alt="" class="img-fluid"></a>
                                <p>We are looking to you</p>
                            </div>

                            <div class="col-md-12 col-xl-12 mt-1 text-center">
                                <h3 class="text-center">Payment system</h3>
                                <a href="./images/payment.jpg" data-lightbox="mygallery"><img src="./images/paymentAnimation.gif" alt="" class="img-fluid"></a>
                                <p>We are looking to you</p>
