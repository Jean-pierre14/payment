                ...
                <div class="body-student">
                    ...
                    <ul id="normal-list">
                        ...
                        <li title="Student <?php print $stud_name . ' ' . $stud_sname . ' ni  ' . $row['class']; ?>"><a
                                href="py.php?student=<?php print $stud_id; ?>">
                                <?php print $stud_name . ' ' . $stud_sname; ?>
                            </a>
                        </li>
                        <?php else : ?>
                        <li title="Student <?php print $stud_name . ' ' . $stud_sname . ' ni  ' . $row['class']; ?>"><a
                ...
                <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table striped ui m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <?php print $row_pay['mount']; ?>
                                            </td>
                                            <td>
                                                <?php print $row_pay['create_at']; ?>
                                            </td>
                                            <td>
                                                <?php print $row_pay['bank']; ?>
                                            </td>
                                        </tr>
                                        <?php
                                            }
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card m-1 p-1 bg-success white margin-0">
                            ...
                            <p>Department: <span>
                                    <?php print $get_depart; ?>
                                </span></p>
                            <p>Gender: <span>
                                    <?php print $get_sex; ?>
                                </span></p>
                            <p>Register at: <small>
                                    <?php print $get_creat_at; ?>
                                </small></p>
                        </div>
                        <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xl-12 mt-1 text-center">
                        ...
                        <div class="col-md-12 bg-sucess p-2">
                            ...
                            <p class="text-center ui white m-0 p-0">&copy;
                                <?php print date("Y"); ?> copyright
                            </p>
                        </div>
                    </div>
